            ...
            <div style="padding: 5px; height:50px;" class="panel-body">
                ...
                <table id="gallery-grid-filters" class="table table-striped filters">
                    ...
                    <tr id="user-visit-log-grid-filters" class="filters">
                        <td style="width: auto;">
                            <?= $form->field($searchModel, 'album_id')->dropDownList(ArrayHelper::merge(['' => Yii::t('art/media', 'All Media Items')], Album::getAlbums(true, true)), ['prompt' => '']) ?>
                        </td>
                        <td style="width: auto;">
                        ...
                        <?php if (User::hasPermission('uploadMedia')): ?>
                            <td style="width: 1%;">
                                <?= Html::a(Yii::t('art/media', 'Upload New File'), ($mode == 'modal') ? ['/media/manage/uploader', 'mode' => 'modal'] : ['/media/manage/uploader'], ['class' => 'btn btn-primary pull-right']) ?>
                            </td>
                        <?php endif; ?>
                    </tr>
    ...
    <div class="col-sm-4">
        ...
        <div class="panel panel-default">
            <div class="panel-body media-details">
                <div class="dashboard">
                    <h5><?= Yii::t('art/media', 'Media Details') ?>:</h5>

                    <div id="fileinfo">
                        <h6><?= Yii::t('art/media', 'Please, select file to view details.') ?></h6>
                    </div>
                </div>
            </div>
        </div>
