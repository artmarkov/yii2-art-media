...
use artsoft\media\assets\FileInputAsset;
use Yii;
...
class FileInput extends InputWidget
{
    ...
    public function init()
    {
        ...
        $this->buttonName = Yii::t('art', 'Browse');
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/artsoft/yii2-art-media/views/manage/modal.php', [
